                            ...
                            <div class="col mb-2">
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item">Номер производителя: {{$product->manufacturer_number}}</li>
                                        <li class="list-group-item">Мера: {{$product->units}}</li>
                                        <li class="list-group-item">Оригинальный номер: {{$product->original_number}}</li>
                                        <li class="list-group-item">Минимум в упаковке: {{$product->min_in_pack}}</li>
                                    </ul>
                                    <div class="card-body">
